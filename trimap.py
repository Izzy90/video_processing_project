...
import os
from utilities import create_video_from_image_folder
...
def trimap(video_input):
    ...
    create_video_from_image_folder(frames_folder, output_folder, shape=(1280,720))
